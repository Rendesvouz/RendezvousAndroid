...
const UserLifeCoachDetails = ({navigation, route}) => {
    ...
    <SafeAreaViewComponent>
      ...
      <ScrollView
        ...
        <View style={{padding: 10}}>
          ...
          <Text style={[styles.therapistEducation, {color: theme?.text}]}>
      ...
      <FixedBottomContainer top={1.19}>
        <FormButton
          ...
          width={1.1}
          onPress={() => {
            navigation.navigate('UserLifeCoachBooking', item);
          }}
          // formError={formError}
        />
...
export default UserLifeCoachDetails;
